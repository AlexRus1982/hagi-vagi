<div 
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" style="min-width: 720px;">
        <div class="modal-content shadow">
            <div class="modal-header bg-primary bg-gradient text-white">
                <h1 class="modal-title fs-5 w-100 d-flex flex-row" id="productEditModalLabel">Товар<div class="px-2">-</div><div id="productName"></div></h1>
            ...
            <div class="modal-body">
                ...
                <div class="accordion mb-3" id="accordionSecription">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne">
                            <button class="accordion-button collapsed p-2" type="button" data-bs-toggle="collapse" data-bs-target="#collapseDescription" aria-expanded="false" aria-controls="collapseDescription" style="height: 38px;">
                                Описание
                            </button>
                        </h2>
                        <div id="collapseDescription" class="accordion-collapse collapse p-3" aria-labelledby="headingOne" data-bs-parent="#accordionSecription">
                ...
                <div class="accordion mb-3" id="accordionImages">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne">
                            <button class="accordion-button collapsed p-2" type="button" data-bs-toggle="collapse" data-bs-target="#collapseImages" aria-expanded="false" aria-controls="collapseImages" style="height: 38px;">
                                Изображения
                            </button>
                        </h2>
                        <div id="collapseImages" class="accordion-collapse collapse p-3" aria-labelledby="headingOne" data-bs-parent="#accordionImages">
                ...
                <div class="accordion mb-3" id="accordionProperties">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne">
                            <button class="accordion-button collapsed p-2" type="button" data-bs-toggle="collapse" data-bs-target="#collapseProperties" aria-expanded="false" aria-controls="collapseProperties" style="height: 38px;">
                                Свойства
                            </button>
                        </h2>
                        <div id="collapseProperties" class="accordion-collapse collapse p-3" aria-labelledby="headingOne" data-bs-parent="#accordionProperties">
            ...
            <div class="modal-footer">
                <button id="product-save-button" type="button" class="btn btn-primary">Сохранить</button>
...
<style>
    #productEditModal .input-group span:first-child {
        min-width: 120px;
    }
