...
<a class="card" target="_blank" rel="noopener noreferrer" href="/product/{{$item['URL адрес']}}" style="text-decoration: none; color: #000000; border:none; background: none;">
    <div class="card m-2 ms-0 shadow p-0" style="min-width: 17rem; width: 17rem; height: 430px; margin-top: 13px!important; margin-bottom: 13px!important;">
        ...
        <div class="card-body d-flex flex-column">
            ...
            <div class="btn-group" role="group">
                <button type="button" class="basketButton btn btn-primary" item_id="{{ $item_id }}" style="border-color: white;">В корзину</button>
                <button type="button" class="wishButton btn btn-primary" style="max-width: 50px; border-color: white;" item_id="{{ $item_id }}" title="В желания">
