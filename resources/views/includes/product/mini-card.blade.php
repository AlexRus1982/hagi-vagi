...
<a class="card" target="_blank" rel="noopener noreferrer" href="/product/{{$item['URL адрес']}}" style="text-decoration: none; color: #000000; border:none; background: none;">
    <div class="card m-2 ms-0 shadow p-1" style="min-width: 10rem; width: 10rem; height: 295px;">
        ...
        <div class="card-body d-flex flex-column p-2">
            ...
            <p class="card-text mt-auto mb-0">Цена {{$item['Цена']}}<svg style="margin: 0px 0px 3px 0px;" width="16px" height="16px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
